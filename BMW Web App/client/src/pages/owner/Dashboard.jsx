...
const Dashboard = () => {
    ...
    const dashboardCards = [
        ...
        { title: "Total Bookings", value: data.totalBookings, icon: assets.
        listIconColored },
        { title: "Pending", value: data.pendingBookings, icon: assets.
        cautionIconColored },
        { title: "Confirmed", value: data.completedBookings, icon: assets.
        listIconColored },
    ]
        ...
        <div className='px-4 pt-10 md:px-10 flex-1'>
            ...
            <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
                ...
                md:max-w-xs'>
                    ...
                    <p className='text-3xl mt-6 font-semibold text-primary'>{currency}{data.
                    monthlyRevenue}</p>
                </div>
            </div>
        </div>
